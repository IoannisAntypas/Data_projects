...
var margin = { left:80, right:20, top:50, bottom:150 };
...
var t = d3.transition().duration(2700);
...
d3.csv("data/per_instrument.csv", function(data){
    console.log(data);
...
function update(data) {
    ...
    x.domain(data.map(function(d){ return d['Funding instrument'] }));
...
;
    ...
    rects.enter()
        .append("rect")
            ...
            .attr("y", y(0))
            .attr("height", 0)
            .attr("x", function(d){ return x(d['Funding instrument']) })
    ...
    var label = flag ? "Contracted per Instrument" : "Paid per Instrument";
    yLabel.text(label);
